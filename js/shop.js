...
async function loadSaleStats() {
  ...
  try {
    ...
    // 2) Сколько уже продано (складываем phases[i].sold)
    const PHASE_COUNT = 3;
    let soldBN = 0n;
    ...
    // 7) Основной пул (cap − refReserve − initialBonus) и остаток
